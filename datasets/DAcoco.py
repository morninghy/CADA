...
def build_city_DA(image_set, args,strong_aug):
    ...
    #---源域
    PATHS_Source = {
        "train": (r"D:\papercode\DATR-main\data\datasets\cityscapes\leftImg8bit\train",
                  r"D:\papercode\DATR-main\data\datasets\annotions\cityscapes_train_coco_format.json"),
        "val": (r"D:\papercode\DATR-main\data\datasets\cityscapes\leftImg8bit\val",
                r"D:\papercode\DATR-main\data\datasets\annotions\cityscapes_val_coco_format.json"),
    }
    #----目标域
    PATHS_Target = {
        "train": (r"D:\papercode\DATR-main\data\datasets\cityscapes_foggy\leftImg8bit\train",
                  r"D:\papercode\DATR-main\data\datasets\annotions\cityscapes_train_coco_format_0.02.json"),
        "val": (r"D:\papercode\DATR-main\data\datasets\cityscapes_foggy\leftImg8bit\val",
                r"D:\papercode\DATR-main\data\datasets\annotions\cityscapes_val_coco_format_0.02.json"),
    }
