...
#     sys.argv = [
#         'main.py',
#         '--dataset_file', 'city',  # 数据集类型：city
#         '--output_dir', 'logs/DINO_SCityscapes2FoggyCityscapes/R50_ms4',  # 输出目录
#         '-c', 'config/DA/Cityscapes2FoggyCityscapes/DINO_4scale_C2F.py',  # 配置文件路径
#         '--options',
#         'dn_scalar=100',
#         'embed_init_tgt=TRUE',
#         'dn_label_coef=1.0',
