...
model_config_path = "config/DA/Cityscapes2FoggyCityscapes/DINO_4scale_C2F.py" # change the path of the model config file
model_checkpoint_path = "weights/city2fog_city/best_model.pth" # change the path of the model checkpoint
...
if __name__ == '__main__':
    img_dir = r'D:\papercode\DATR-main\data\datasets\cityscapes_foggy\leftImg8bit\test\berlin'
    save_dir = 'D:\作业\开题\可视化testours'
  ...
  #  label_list = ['car',]
    ...
    for n,img_name in enumerate(fliter_img_list):
        ...
        select_mask = (scores > thershold) & (labels > 0)
